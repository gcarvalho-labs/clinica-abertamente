...
export class ServicesComponent {
  services = [
    ...
    },
    {
      ...
      subtitle: 'Ler mais >',
      icon: { class: 'fa-solid fa-people-arrows' },
    },
    {
    ...
    },
    {
      ...
      subtitle: 'Ler mais >',
      icon: { class: 'fa-solid fa-compass' },
    },
    {
      ...
      subtitle: 'Ler mais >',
      icon: { class: 'fa-solid fa-book-open-reader' },
    },
    {
      ...
      subtitle: 'Ler mais >',
      icon: { class: 'fa-solid fa-child-reaching' },
    },
  ];
}
