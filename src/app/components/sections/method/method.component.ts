...
export class MethodComponent {
  ...
  title: string = 'Sua Jornada, Passo a Passo';
  description: string =
    'Acompanhe cada etapa do caminho para o seu bem-estar emocional.';
  ...
  steps = [
    {
      ...
      description:
        'Está pronto para dar o primeiro passo rumo ao seu bem-estar emocional? ' +
    ...
    },
    {
      ...
      description:
        'Encontrar o profissional certo pode fazer toda a diferença na sua experiência\n' +
    ...
    },
    {
      ...
      description:
        'A terapia deve se ajustar à sua rotina, não o contrário. ' +
    ...
    },
    {
      ...
      description:
        'A sua primeira sessão é um momento especial. Aqui, você será recebido com empatia\n' +
    ...
    },
    {
      ...
      description:
        'A terapia é uma experiência transformadora e única. A partir do plano traçado, você\n' +
    ...
    },
    {
      ...
      description:
        'A terapia é um processo de crescimento constante, e estaremos com você em cada\n' +
    ...
    },
    {
      ...
      description:
        'Quando você estiver pronto, finalizamos a terapia com uma avaliação do seu\n' +
